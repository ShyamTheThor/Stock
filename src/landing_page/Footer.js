...
function Footer() {
    return ( 
        <footer style={{backgroundColor:"rgba(245,245,245)"}}>
...
All rights reserved.</p>
                ...
                <div className='col'><p>Support</p><br/>
                <Link to="" style={{textDecoration:"none"}}>Contact us</Link><br/>
                <Link to="" style={{textDecoration:"none"}}>Support portal</Link><br/>
                <Link to="" style={{textDecoration:"none"}}>How to file a complaint?</Link><br/>
                <Link to="" style={{textDecoration:"none"}}>Status of your complaints</Link><br/>
                ...
                <Link to="" style={{textDecoration:"none"}}>Downloads</Link><br/>
                </div>
                ...
                <Link to="" style={{textDecoration:"none"}}>Zerodha Cares (CSR)</Link><br/>
                <Link to="" style={{textDecoration:"none"}}>Zerodha.tech</Link><br/>
                <Link to="" style={{textDecoration:"none"}}>Open source</Link><br/>
                <Link to="" style={{textDecoration:"none"}}>Referral program</Link><br/>
                </div>
            </div>
